  ...
  13:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  2b:	50                   	push   %eax
  2c:	50                   	push   %eax
  2d:	68 94 08 00 00       	push   $0x894
  32:	6a 01                	push   $0x1
  34:	e8 a7 04 00 00       	call   4e0 <printf>
  ...
  5d:	68 e4 08 00 00       	push   $0x8e4
  62:	6a 01                	push   $0x1
  64:	e8 77 04 00 00       	call   4e0 <printf>
        if (ret != wait())
  69:	e8 fd 02 00 00       	call   36b <wait>
  ...
  9a:	e8 41 04 00 00       	call   4e0 <printf>
        ret = fork();
  9f:	e8 b7 02 00 00       	call   35b <fork>
        if (ret < 0)
  ...
  ad:	56                   	push   %esi
  ae:	50                   	push   %eax
  af:	68 c7 08 00 00       	push   $0x8c7
  b4:	6a 01                	push   $0x1
  b6:	e8 25 04 00 00       	call   4e0 <printf>
            exit();
  bb:	e8 a3 02 00 00       	call   363 <exit>
        printf(1, "\nSetting parent as the fork winner ...\n");
  c0:	50                   	push   %eax
  c1:	50                   	push   %eax
  c2:	68 6c 08 00 00       	push   $0x86c
  c7:	6a 01                	push   $0x1
  ...
  d8:	51                   	push   %ecx
  d9:	51                   	push   %ecx
  da:	68 db 08 00 00       	push   $0x8db
  df:	6a 01                	push   $0x1
  e1:	e8 fa 03 00 00       	call   4e0 <printf>
            exit();
  e6:	e8 78 02 00 00       	call   363 <exit>
        printf(1, "Usage: %s 0|1 \n"
  eb:	52                   	push   %edx
  ec:	ff 30                	push   (%eax)
  ee:	68 08 08 00 00       	push   $0x808
  f3:	6a 01                	push   $0x1
 ...
 106:	6a 01                	push   $0x1
 108:	e8 d3 03 00 00       	call   4e0 <printf>

    fork_winner(0); // set back to default
 10d:	31 d2                	xor    %edx,%edx
 10f:	89 14 24             	mov    %edx,(%esp)
 112:	e8 04 03 00 00       	call   41b <fork_winner>
 ...
 448:	89 d1                	mov    %edx,%ecx
{
 ...
 47b:	0f b6 92 60 09 00 00 	movzbl 0x960(%edx),%edx
 ...
 4e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 554:	ff 24 85 08 09 00 00 	jmp    *0x908(,%eax,4)
 ...
 680:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 685:	bb fe 08 00 00       	mov    $0x8fe,%ebx
 ...
 691:	a1 04 0c 00 00       	mov    0xc04,%eax
{
 ...
 707:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70a:	89 15 04 0c 00 00    	mov    %edx,0xc04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 04 0c 00 00    	mov    0xc04,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76b:	39 05 04 0c 00 00    	cmp    %eax,0xc04
 ...
 78e:	e8 fd fe ff ff       	call   690 <free>
  return freep;
 793:	8b 15 04 0c 00 00    	mov    0xc04,%edx
 ...
 7d7:	0c 00 00 
    base.s.size = 0;
 7da:	b8 08 0c 00 00       	mov    $0xc08,%eax
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 08 0c 00 00 08 	movl   $0xc08,0xc08
 7e6:	0c 00 00 
    base.s.size = 0;
 7e9:	c7 05 0c 0c 00 00 00 	movl   $0x0,0xc0c
 7f0:	00 00 00 
    if(p->s.size >= nunits){
